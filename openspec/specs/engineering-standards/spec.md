...
All code changes, pull requests, and OpenSpec archive workflows SHALL satisfy a mandatory Zero-Warning quality gate before completion.
...
- **THEN** the build MUST verify: `mvnw clean test-compile` succeeds, all unit tests pass (100% green), zero unused imports exist, zero orphan dead fields exist, and the IDE Problems panel contains zero errors and zero warnings
