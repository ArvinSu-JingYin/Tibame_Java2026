...
| **CI/CD 管線與品質守門** | [github_actions_ci_pipeline_and_governance_exploration.md](explorations/github_actions_ci_pipeline_and_governance_exploration.md) | [github-actions-ci-guide.md](guides/github-actions-ci-guide.md) | GitHub Actions 雙層分流管線、PR 繁中 Commit 規範門禁、OpenSpec 規格驗證、Playwright E2E 快取策略、分支保護規則 |
